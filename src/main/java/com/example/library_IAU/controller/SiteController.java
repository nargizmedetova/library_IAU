...
public class SiteController {
    ...
    public SiteController(BooksService booksService, UsersService usersService, BooksRepository booksRepository){
    ...
    @GetMapping("/signIn")
    public static String signIn(Model model){
    ...
    public String postSignIn(@ModelAttribute UsersModel usersModel){
        ...
        return authenticate == null?"signIn":"redirect:/main";
    }
    @GetMapping("/signUp")
